...
export default function ProductsTagC() {
  const { tag = "popular" } = useParams();
  const { products , loading } = useProductFetcher(tag, 1);
      ...
      <div className="mb-2">
        ...
        <label className="block text-sm text-gray-700">
          <input
            ...
            onChange={() =>
              setFilters((prev: any) => ({ ...prev, discount: !prev.discount }))
            }
            className="mr-2"
          />
          With Discount
        ...
        <label className="block text-sm text-gray-700">
          <input
            ...
            onChange={() =>
              setFilters((prev: any) => ({ ...prev, inStock: !prev.inStock }))
            }
            className="mr-2"
          />
          In Stock Only
